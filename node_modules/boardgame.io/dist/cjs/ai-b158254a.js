...
function () {
  function Bot(_ref) {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, Bot);

    _rollupPluginBabelHelpers._defineProperty(this, "enumerate", function (G, ctx, playerID) {
  ...
  _rollupPluginBabelHelpers._createClass(Bot, [{
    key: "addOpt",
...
/*#__PURE__*/
function (_Bot) {
  _rollupPluginBabelHelpers._inherits(MCTSBot, _Bot);
  ...
  function MCTSBot(_ref) {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, MCTSBot);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(MCTSBot).call(this, {
      enumerate: enumerate,
      seed: seed
    }));
  ...
  _rollupPluginBabelHelpers._createClass(MCTSBot, [{
    key: "createNode",
...
/*#__PURE__*/
function (_Bot) {
  _rollupPluginBabelHelpers._inherits(RandomBot, _Bot);

  function RandomBot() {
    _rollupPluginBabelHelpers._classCallCheck(this, RandomBot);

    return _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(RandomBot).apply(this, arguments));
  }

  _rollupPluginBabelHelpers._createClass(RandomBot, [{
    key: "play",
