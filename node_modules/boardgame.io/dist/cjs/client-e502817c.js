...
var Debug = require('./Debug-00ea1891.js');
...
function () {
  function _ClientImpl(_ref) {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, _ClientImpl);
    ...
    if (!multiplayer) {
      initialState = initialize.InitializeGame({
        game: this.game,
        numPlayers: numPlayers
      });
    }
    ...
    this.reset = function () {
      _this.store.dispatch(reducer.reset(initialState));
    };
            ...
            case reducer.GAME_EVENT:
              {
                ...
                _this.log = [].concat(_rollupPluginBabelHelpers._toConsumableArray(_this.log), _rollupPluginBabelHelpers._toConsumableArray(deltalog));
                break;
              }
            ...
            case reducer.UPDATE:
              {
                ...
                _this.log = [].concat(_rollupPluginBabelHelpers._toConsumableArray(_this.log), _rollupPluginBabelHelpers._toConsumableArray(_deltalog));
                break;
              }
  ...
  _rollupPluginBabelHelpers._createClass(_ClientImpl, [{
    ...
    value: function getState() {
      ...
      var ret = _rollupPluginBabelHelpers._objectSpread2({}, state, {
        isActive: isActive,
        G: G,
        log: this.log
      });
      ...
      ret = _rollupPluginBabelHelpers._objectSpread2({}, ret, {
