...
var pluginPlayer = {
  fnWrap: function fnWrap(moveFn) {
    return function (G, ctx) {
      ...
      G = _rollupPluginBabelHelpers._objectSpread2({}, G, {
        player: player
      });
      var other = null;
      var opponent = null;
      ...
      var players = _rollupPluginBabelHelpers._objectSpread2({}, G.players, _rollupPluginBabelHelpers._defineProperty({}, current, 'player' in G ? G.player : G.players[current]));
...

      {
        ...
        var _G = G,
            ...
            rest = _rollupPluginBabelHelpers._objectWithoutProperties(_G, ["player", "opponent"]);

        return _rollupPluginBabelHelpers._objectSpread2({}, rest, {
          players: players
        });
      }
    };
  ...
  setup: {
    G: function G(_G2, ctx, game) {
      ...
      return _rollupPluginBabelHelpers._objectSpread2({}, _G2, {
        players: players
      });
    }
  }
