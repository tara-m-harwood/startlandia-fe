...
require('redux');
require('./reducer-c8fe777c.js');
require('immer');
require('./Debug-00ea1891.js');
require('flatted');
var ai = require('./ai-b158254a.js');
require('./initialize-4fe5e709.js');
var client = require('./client-e502817c.js');
var React = _interopDefault(require('react'));
var PropTypes = _interopDefault(require('prop-types'));
var Cookies = _interopDefault(require('react-cookies'));
var socketio = require('./socketio-623dd281.js');
require('./master-6196104f.js');
...
function Client(opts) {
  ...
  function (_React$Component) {
    ...
    function WrappedBoard(props) {
      ...
      _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(WrappedBoard).call(this, props));
    ...
    _rollupPluginBabelHelpers._createClass(WrappedBoard, [{
      ...
      value: function render() {
        ...
        if (board) {
          _board = React.createElement(board, _rollupPluginBabelHelpers._objectSpread2({}, state, {}, this.props, {
...
function () {
  function _LobbyConnectionImpl(_ref) {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, _LobbyConnectionImpl);
  ...
  _rollupPluginBabelHelpers._createClass(_LobbyConnectionImpl, [{
    key: "_baseUrl",
...
/*#__PURE__*/
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(LobbyLoginForm, _React$Component);
  ...
  function LobbyLoginForm() {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, LobbyLoginForm);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, (_getPrototypeOf2 = _rollupPluginBabelHelpers._getPrototypeOf(LobbyLoginForm)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "state", {
      playerName: _this.props.playerName,
      nameErrorMsg: ''
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onClickEnter", function () {
      if (_this.state.playerName === '') return;

      _this.props.onEnter(_this.state.playerName);
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onKeyPress", function (event) {
      if (event.key === 'Enter') {
        _this.onClickEnter();
      }
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onChangePlayerName", function (event) {
  ...
  _rollupPluginBabelHelpers._createClass(LobbyLoginForm, [{
    key: "render",
    value: function render() {
...
_rollupPluginBabelHelpers._defineProperty(LobbyLoginForm, "propTypes", {
  playerName: PropTypes.string,
  onEnter: PropTypes.func.isRequired
});

_rollupPluginBabelHelpers._defineProperty(LobbyLoginForm, "defaultProps", {
  playerName: ''
});
...
/*#__PURE__*/
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(LobbyRoomInstance, _React$Component);
  ...
  function LobbyRoomInstance() {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, LobbyRoomInstance);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, (_getPrototypeOf2 = _rollupPluginBabelHelpers._getPrototypeOf(LobbyRoomInstance)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createSeat", function (player) {
      return player.name || '[free]';
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createButtonJoin", function (inst, seatId) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createButtonLeave", function (inst) {
      return React.createElement("button", {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createButtonPlay", function (inst, seatId) {
      return React.createElement("button", {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createButtonSpectate", function (inst) {
      return React.createElement("button", {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createInstanceButtons", function (inst) {
  ...
  _rollupPluginBabelHelpers._createClass(LobbyRoomInstance, [{
    key: "render",
    value: function render() {
...
_rollupPluginBabelHelpers._defineProperty(LobbyRoomInstance, "propTypes", {
...
/*#__PURE__*/
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(LobbyCreateRoomForm, _React$Component);

  function LobbyCreateRoomForm(props) {
    var _this;

    _rollupPluginBabelHelpers._classCallCheck(this, LobbyCreateRoomForm);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(LobbyCreateRoomForm).call(this, props));
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createGameNameOption", function (game, idx) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createNumPlayersOption", function (idx) {
      return React.createElement("option", {
        key: 'num-option-' + idx,
        value: idx
      }, idx);
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createNumPlayersRange", function (game) {
      return _rollupPluginBabelHelpers._toConsumableArray(new Array(game.maxPlayers + 1).keys()).slice(game.minPlayers);
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onChangeNumPlayers", function (event) {
      _this.setState({
        numPlayers: Number.parseInt(event.target.value)
      });
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onChangeSelectedGame", function (event) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "onClickCreate", function () {
  ...
  _rollupPluginBabelHelpers._createClass(LobbyCreateRoomForm, [{
    key: "render",
    value: function render() {
      var _this2 = this;
...
_rollupPluginBabelHelpers._defineProperty(LobbyCreateRoomForm, "propTypes", {
...
/*#__PURE__*/
function (_React$Component) {
  _rollupPluginBabelHelpers._inherits(Lobby, _React$Component);

  function Lobby(_props) {
    var _this;

    _rollupPluginBabelHelpers._classCallCheck(this, Lobby);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(Lobby).call(this, _props));
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createConnection", function (props) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_updateCredentials", function (playerName, credentials) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_updateConnection", async function () {
      await _this.connection.refresh();

      _this.forceUpdate();
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_enterLobby", function (playerName) {
      _this.setState({
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_exitLobby", async function () {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_createRoom", async function (gameName, numPlayers) {
      try {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_joinRoom", async function (gameName, gameID, playerID) {
      try {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_leaveRoom", async function (gameName, gameID) {
      try {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_startGame", function (gameName, gameOpts) {
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_exitRoom", function () {
      _this.setState({
        phase: LobbyPhases.LIST,
        runningGame: null
      });
    ...
    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "_getPhaseVisibility", function (phase) {
      return _this.state.phase !== phase ? 'hidden' : 'phase';
    });

    _rollupPluginBabelHelpers._defineProperty(_rollupPluginBabelHelpers._assertThisInitialized(_this), "renderRooms", function (rooms, playerName) {
  ...
  _rollupPluginBabelHelpers._createClass(Lobby, [{
    key: "componentDidMount",
    value: function componentDidMount() {
...
_rollupPluginBabelHelpers._defineProperty(Lobby, "propTypes", {
...
_rollupPluginBabelHelpers._defineProperty(Lobby, "defaultProps", {
  debug: false,
