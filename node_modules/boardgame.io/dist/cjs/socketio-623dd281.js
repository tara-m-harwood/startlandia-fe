...
var master = require('./master-6196104f.js');
...
function () {
   ...
   */
  function InMemory() {
    _rollupPluginBabelHelpers._classCallCheck(this, InMemory);
  ...
  _rollupPluginBabelHelpers._createClass(InMemory, [{
    key: "connect",
    ...
    key: "list",
    value: function list() {
      return _rollupPluginBabelHelpers._toConsumableArray(this.games.keys());
    }
  }]);
...
var Transport = function Transport(_ref) {
  ...
  _rollupPluginBabelHelpers._classCallCheck(this, Transport);

  this.store = store;
  this.gameName = gameName || 'default';
  this.playerID = playerID || null;
  this.gameID = "".concat(this.gameName, ":").concat(gameID || 'default');
...
function LocalMaster(_ref) {
  ...
  var send = function send(_ref2) {
    ...
    if (callback !== undefined) {
      callback.apply(null, [type].concat(_rollupPluginBabelHelpers._toConsumableArray(args)));
    }
  };
  ...
  master$1.executeSynchronously = true;
...
/*#__PURE__*/
function (_Transport) {
  _rollupPluginBabelHelpers._inherits(LocalTransport, _Transport);
  ...
  function LocalTransport(_ref4) {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, LocalTransport);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(LocalTransport).call(this, {
      store: store,
      gameName: gameName,
      playerID: playerID,
      gameID: gameID,
  ...
  _rollupPluginBabelHelpers._createClass(LocalTransport, [{
    key: "onUpdate",
    ...
    value: function onSync(gameID, state, log) {
      if (gameID == this.gameID) {
        var action = reducer.sync(state, log);
        this.store.dispatch(action);
      }
    }
    /**
...
function Local(opts) {
  return function (transportOpts) {
    ...
    return new LocalTransport(_rollupPluginBabelHelpers._objectSpread2({
      master: master
    }, transportOpts));
  };
}
...
/*#__PURE__*/
function (_Transport) {
  _rollupPluginBabelHelpers._inherits(SocketIOTransport, _Transport);
  ...
  function SocketIOTransport() {
    ...
    _rollupPluginBabelHelpers._classCallCheck(this, SocketIOTransport);

    _this = _rollupPluginBabelHelpers._possibleConstructorReturn(this, _rollupPluginBabelHelpers._getPrototypeOf(SocketIOTransport).call(this, {
      store: store,
      gameName: gameName,
      playerID: playerID,
      gameID: gameID,
  ...
  _rollupPluginBabelHelpers._createClass(SocketIOTransport, [{
    key: "onAction",
    value: function onAction(state, action) {
    ...
    value: function connect() {
      ...
      this.socket.on('sync', function (gameID, state, log, gameMetadata) {
        if (gameID == _this2.gameID) {
          ...
          _this2.gameMetadataCallback(gameMetadata);
...
function SocketIO() {
  ...
  return function (transportOpts) {
    return new SocketIOTransport(_rollupPluginBabelHelpers._objectSpread2({
      server: server,
